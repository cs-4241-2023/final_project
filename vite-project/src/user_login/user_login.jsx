...
function userLogin() {
    ...
    function setUserLoginFeedback(message) {

        if(message === "MissingInformation") {
            setUserLoginFeedbackText("The login information you submitted cannot be saved. There is missing information in at least one input field.")
        } else if(message === "WhitespacePresent") {
            setUserLoginFeedbackText("The login information you submitted cannot be saved. Both the username and password cannot contain any whitespace.")
    ...
    async function handleLoginSubmit(event) {
        ...
        if(serverMessage === "SuccessfulUserAuthentication.") {
            ...
            setUserLoginFeedback(JSON.stringify(serverMessage))
        }
    }
